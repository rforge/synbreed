...
summary.LDdf <- function(object,...){
     ...
     ret <- data.frame(noM=unlist(lapply(LDdf,noM)),
                       avgr2= unlist(lapply(LDdf,avgr2)),
                       minr2= unlist(lapply(LDdf,minr2)),
                       maxr2= unlist(lapply(LDdf,maxr2)),
                       Pr02=unlist(lapply(LDdf,pr)),
                       averDist = unlist(lapply(LDdf,avgr2)),
                       maxDist = unlist(lapply(LDdf,maxd)))
     return(ret)
}
...
summary.LDmat <- function(object,...){
     ...
     ret <- data.frame(noM=unlist(lapply(LDmat$LD,ncol)),
                       avgr2= unlist(lapply(LDmat$LD,avgr2)),
                       minr2= unlist(lapply(LDmat$LD,minr2)),
                       maxr2= unlist(lapply(LDmat$LD,maxr2)),
                       Pr02=unlist(lapply(LDmat$LD,pr)),
                       averDist = unlist(lapply(LDmat$distance,avgr2)),
                       maxDist = unlist(lapply(LDmat$distance,max)))
     return(ret)
}
