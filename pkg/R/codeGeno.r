...
codeGeno <- function(gpData,impute=FALSE,impute.type=c("family","beagle","beagleAfterFamily","random","fix"),replace.value=NULL,maf=NULL,nmiss=NULL,label.heter="AB",keep.identical=TRUE,verbose=FALSE){
